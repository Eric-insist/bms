...
<script>
    ...
    layui.use(['jquery', 'treeSelect', 'form', 'layer', 'table', 'upload','laydate'], function () {
        ...
        //表单提交
        form.on('submit(late-form-submit)', function (data) {
            var inputData = data.field;
            console.log(inputData);
            $.ajax({
                url: '<%=basePath%>late/add',
                type: 'post',
                data: inputData,
                dataType: 'json',
                success: function (data1) {
                    ...
                    if (data1.code == 0) {
                        var log = {};
                        log.type = 1;
                        log.description = "新增了晚归记录记录,姓名:"+data.name+",学号:"+data.account;
                        $.ajax({
...
<div class="layui-card layadmin-header" style="height: 50px; line-height: 50px; padding-left: 15px;">
    <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
        <a lay-href="">学生中心</a><span lay-separator="">/</span> <a><cite>晚归录入</cite></a>
    </div>
</div>
    ...
    <div id="inBedroomDiv" style="padding: 10px; background-color: #F2F2F2;">
        <div class="layui-card">
            <div class="layui-card-body">
                <div id="form-modal">
                    <div class="layui-form" lay-filter="late-form"
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <input type="text" name="time" id="time" value="" lay-verify="required"
                        ...
                        <div class="layui-form-item" style="margin-top: 30px">
                            <div class="layui-inline">
                                ...
                                <div class="layui-input-inline">
                                    <textarea name="reason" placeholder="请输入晚归原因" class="layui-textarea" lay-verify="required" style="width: 514px"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="button" lay-submit=""
                                       lay-filter="late-form-submit" value="录入" class="layui-btn">
                            </div>
                        </div>
                    </div>
                </div>
