...
<div class="layui-card layadmin-header" style="height: 50px; line-height: 50px; padding-left: 15px;">
    <div class="layui-breadcrumb" lay-filter="breadcrumb" style="visibility: visible;">
        <a lay-href="">系统设置</a><span lay-separator="">/</span> <a><cite>用户列表</cite></a>
    </div>
</div>
...
<div class="layui-form layui-card-header layuiadmin-card-header-auto" lay-filter="layadmin-userfront-formlist">
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" name="name" placeholder="输入姓名、账号、联系电话、所在集体" autocomplete="off" class="layui-input"
                       style="width: 255px">
            </div>
        </div>
        <div class="layui-inline">
...
<script>
    ...
    layui.use(['jquery', 'treeSelect', 'form', 'layer', 'table'], function () {
        ...
        form.on('submit(search-btn)', function (data) {
            ...
            user.search = $.trim(field.name);
            user.roleId = $("#roleId").val();
            user.id = $("#userId").val();
            //表格重载条件
            console.log(user);
            table.reload('test', {
                where: user, page: {curr: 1}
            });
        });
        form.verify({
            ...
            , cols: [[
                ...
                , {
                    ...
                    templet: function (res) {
                        if (res.roleId == 1) return "系统管理员";
                        else if (res.roleId == 2) return '宿舍管理员';
                        else if (res.roleId == 3) return "辅导员";
                        else if (res.roleId == 4) return "学生";
                        else if (res.roleId == 5) return "维修人员";
                        else return "身份不明"
                    }
                }
